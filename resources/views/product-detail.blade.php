                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-6 mb-6">
                                ...
                                <div class="flex items-center justify-center space-x-3 sm:space-x-0">
                                    <div class="quantity-control">
                                        ...
                                        <input type="number" id="quantity" value="1" min="1" max="{{ $product->stock }}" class="quantity-input border-emerald-300 focus:border-emerald-500">
                                    ...
                                    <span class="text-xs sm:text-sm text-emerald-600 ml-3 sm:ml-4 font-medium">{{ $product->stock }} available</span>
                                </div>
                            </div>
