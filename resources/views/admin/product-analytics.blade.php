    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.products') }}" class="text-blue-600 hover:text-blue-800 transition-colors duration-200">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Analytics Dashboard - Product ID: #{{ $product->id }}</p>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.edit-product', $product) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                    </svg>
                    Edit Product
                </a>
                <a href="{{ route('product.show', $product->slug) }}" target="_blank" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($analytics['cart_additions']) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($analytics['wishlist_additions']) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($analytics['views']) }}</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="text-center">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-lg font-bold text-blue-600">{{ $analytics['weekly_summary']['this_week']['cart'] }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Wishlist</span>
                        <span class="text-lg font-bold text-red-600">{{ $analytics['weekly_summary']['this_week']['wishlist'] }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Views</span>
                        <span class="text-lg font-bold text-green-600">{{ $analytics['weekly_summary']['this_week']['views'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Cart</span>
                        <span class="text-lg font-bold text-blue-600">{{ $analytics['weekly_summary']['last_week']['cart'] }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Wishlist</span>
                        <span class="text-lg font-bold text-red-600">{{ $analytics['weekly_summary']['last_week']['wishlist'] }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Views</span>
                        <span class="text-lg font-bold text-green-600">{{ $analytics['weekly_summary']['last_week']['views'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Cart</span>
                        <span class="text-lg font-bold {{ $cartChange >= 0 ? 'text-green-600' : 'text-red-600' }}">
                            {{ $cartChange >= 0 ? '+' : '' }}{{ $cartChange }}%
                        </span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Wishlist</span>
                        <span class="text-lg font-bold {{ $wishlistChange >= 0 ? 'text-green-600' : 'text-red-600' }}">
                            {{ $wishlistChange >= 0 ? '+' : '' }}{{ $wishlistChange }}%
                        </span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600">Views</span>
                        <span class="text-lg font-bold {{ $viewsChange >= 0 ? 'text-green-600' : 'text-red-600' }}">
...
const cartData = @json($analytics['daily_cart_data']);
const wishlistData = @json($analytics['daily_wishlist_data']);
