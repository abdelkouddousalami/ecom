<!-- Footer -->
<footer class="bg-white text-gray-800 pt-20 pb-12 mt-20 border-t-4 border-red-500">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 footer-grid">
            <!-- Company Info -->
            <div class="flex flex-col items-start">
                <img src="<?php echo e(asset('images/logos/logo.png')); ?>" alt="L3OCHAQ Store Logo" class="h-10 w-auto mb-4 object-contain">
                ...
                <div class="flex space-x-3 mt-2">
                    ...
                    <a href="https://www.tiktok.com/@l3ochaqgift?_t=ZM-8z44amkrYQi&_r=1" target="_blank" class="text-red-400 hover:text-red-600 transition duration-300" title="TikTok">
            ...
            <!-- Contact Info -->
            <div>
                <h4 class="text-lg font-bold mb-4 text-gray-900 tracking-wide" style="font-family: 'Playfair Display', serif;">Contact</h4>
                <ul class="space-y-2 text-sm text-gray-600" style="font-family: 'Playfair Display', serif;">
