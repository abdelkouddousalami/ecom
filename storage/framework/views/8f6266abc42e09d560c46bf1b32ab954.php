...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['activePage' => 'home']));
...
foreach (array_filter((['activePage' => 'home']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                <a href="/" class="flex-shrink-0">
                    <img src="<?php echo e(asset('images/logos/logo.png')); ?>" 
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="/" class="<?php echo e($activePage === 'home' ? 'text-red-600 hover:text-red-700' : 'text-gray-600 hover:text-red-600'); ?> font-medium transition duration-300" style="font-family: 'Playfair Display', serif;">Home</a>
                <a href="/products" class="<?php echo e($activePage === 'products' ? 'text-red-600 hover:text-red-700' : 'text-gray-600 hover:text-red-600'); ?> font-medium transition duration-300" style="font-family: 'Playfair Display', serif;">Products</a>
                <a href="/orders" class="<?php echo e($activePage === 'orders' ? 'text-red-600 hover:text-red-700' : 'text-gray-600 hover:text-red-600'); ?> font-medium transition duration-300" style="font-family: 'Playfair Display', serif;">Orders</a>
                <a href="#" class="<?php echo e($activePage === 'contact' ? 'text-red-600 hover:text-red-700' : 'text-gray-600 hover:text-red-600'); ?> font-medium transition duration-300" style="font-family: 'Playfair Display', serif;">Contact</a>
            </div>
...
<div id="mobileMenu" class="mobile-menu">
    ...
    <div class="space-y-6">
        <a href="/" class="block text-white text-xl <?php echo e($activePage === 'home' ? 'font-semibold bg-white/10' : 'font-medium hover:bg-white/10'); ?> py-3 px-4 rounded-lg transition duration-300" style="font-family: 'Playfair Display', serif;">
            Home
        </a>
        <a href="/products" class="block text-white text-xl <?php echo e($activePage === 'products' ? 'font-semibold bg-white/10' : 'font-medium hover:bg-white/10'); ?> py-3 px-4 rounded-lg transition duration-300" style="font-family: 'Playfair Display', serif;">
            Products
        </a>
        <a href="/orders" class="block text-white text-xl <?php echo e($activePage === 'orders' ? 'font-semibold bg-white/10' : 'font-medium hover:bg-white/10'); ?> py-3 px-4 rounded-lg transition duration-300" style="font-family: 'Playfair Display', serif;">
            Orders
        </a>
        <a href="/wishlist" class="block text-white text-xl <?php echo e($activePage === 'wishlist' ? 'font-semibold bg-white/10' : 'font-medium hover:bg-white/10'); ?> py-3 px-4 rounded-lg transition duration-300" style="font-family: 'Playfair Display', serif;">
            Mes Favoris
        </a>
        <a href="#" class="block text-white text-xl <?php echo e($activePage === 'contact' ? 'font-semibold bg-white/10' : 'font-medium hover:bg-white/10'); ?> py-3 px-4 rounded-lg transition duration-300" style="font-family: 'Playfair Display', serif;">
            Contact
        </a>
