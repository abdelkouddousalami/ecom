        ...
        <div class="max-w-full px-6 sm:px-8 lg:px-12 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="text-center p-6 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div class="text-3xl font-bold text-blue-600"><?php echo e(count($categories)); ?></div>
                ...
                <div class="text-center p-6 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div class="text-3xl font-bold text-green-600"><?php echo e($categories->sum('products_count')); ?></div>
                ...
                <div class="text-center p-6 bg-purple-50 border border-purple-200 rounded-lg">
                    ...
                    <div class="text-3xl font-bold text-purple-600"><?php echo e($categories->count() > 0 ? number_format($categories->sum('products_count') / $categories->count(), 1) : 0); ?></div>
                ...
                <div class="text-center p-6 bg-orange-50 border border-orange-200 rounded-lg">
                    ...
                    <div class="text-3xl font-bold text-orange-600"><?php echo e($categories->where('is_active', true)->count()); ?></div>
                        ...
                        <div class="flex items-center p-4 space-x-6">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        <h4 class="text-lg font-bold text-gray-900 font-playfair"><?php echo e($category->name); ?></h4>
                                        <p class="text-gray-600 text-sm mt-1 truncate"><?php echo e($category->description ?: 'No description available.'); ?></p>
                                    </div>
                                    <!-- Status -->
                                    <div class="flex items-center mx-8">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($category->is_active ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'); ?>">
                                    ...
                                    <div class="flex items-center space-x-2 flex-shrink-0">
                                        ...
                                        <button onclick="deleteCategory(<?php echo e($category->id); ?>, '<?php echo e($category->name); ?>')" class="bg-red-50 hover:bg-red-100 text-red-700 hover:text-red-800 border border-red-200 py-2 px-3 rounded-lg text-sm font-medium transition-colors duration-200">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
