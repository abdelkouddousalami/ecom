                ...
                <?php if(isset($order)): ?>
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
                        ...
                        <p class="text-blue-800">
                            ...
                            <strong>Total:</strong> <?php echo e(number_format($order->total, 2)); ?> DH<br>
                            <strong>Mode de paiement:</strong> <?php echo e($order->getPaymentMethodLabel()); ?>
...
<?php /**PATH C:\xampp\htdocs\Breifs\l3och\ecommerce\resources\views\order-success.blade.php ENDPATH**/ ?>