...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-meta','data' => ['title' => 'Test Products','description' => 'Test description','keywords' => 'test keywords']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Test Products','description' => 'Test description','keywords' => 'test keywords']); ?>
...
<body>
    ...
    <p>This is a minimal test page to check if the seo-meta component works.</p>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Breifs\l3och\ecommerce\resources\views/test-products.blade.php ENDPATH**/ ?>